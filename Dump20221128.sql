...
CREATE TABLE `event` (
  ...
  CONSTRAINT `event_ibfk_1` FOREIGN KEY (`Coupon_id`) REFERENCES `coupons` (`Coupon_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `product_catalog` (
  ...
  PRIMARY KEY (`PCid`),
  KEY `p_id` (`p_id`),
  CONSTRAINT `product_catalog_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `product` (`p_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `register` (
  ...
  `uzip` varchar(45) NOT NULL,
  UNIQUE KEY `primary_address_UNIQUE` (`uemail`),
  UNIQUE KEY `password_UNIQUE` (`upassword`),
  UNIQUE KEY `Zipcode_UNIQUE` (`uzip`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `register` VALUES ('56','34','3467','34','567','45677'),('Lakshman','Klaksh','5678','3456','456','600'),('kl','234','klkaks','kmla','456','2345'),('lakshman','kl123','lop90','kmlakshmam','67','45'),('lakshman','345','3456','kmlashman','453','567');
...
-- Dump completed on 2022-11-28  0:07:23
